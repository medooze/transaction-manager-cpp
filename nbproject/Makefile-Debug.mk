...
${OBJECTDIR}/src/Promise.o: src/Promise.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -Itests -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Promise.o src/Promise.cpp

${OBJECTDIR}/src/TransactionManager.o: src/TransactionManager.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -Itests -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TransactionManager.o src/TransactionManager.cpp
...
${TESTDIR}/tests/main.o: tests/main.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -s -Iinclude -Itests -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/main.o tests/main.cpp
...
${OBJECTDIR}/src/Promise_nomain.o: ${OBJECTDIR}/src/Promise.o src/Promise.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -s -Iinclude -Itests -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Promise_nomain.o src/Promise.cpp;\
	else  \
...
${OBJECTDIR}/src/TransactionManager_nomain.o: ${OBJECTDIR}/src/TransactionManager.o src/TransactionManager.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -s -Iinclude -Itests -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TransactionManager_nomain.o src/TransactionManager.cpp;\
	else  \
