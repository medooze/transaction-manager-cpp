...
public:
	...
	Promise& onaccepted(const std::function<void (const nlohmann::json& data)> &callback);
	Promise& onrejected(const std::function<void (const nlohmann::json& data)> &callback);
